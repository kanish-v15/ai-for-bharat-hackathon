      ...
      <div className={`${showDocs ? 'w-72' : 'w-0'} transition-all duration-300 overflow-hidden border-r border-gray-200 bg-white shrink-0`}>
        <div className="w-72 h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-4">
            {/* Lab Reports */}
            <div>
              <h4 className="text-[10px] font-heading font-semibold text-gray-400 uppercase tracking-wider mb-2 px-1">{t('healthTimeline.labReports')}</h4>
              {labReports.length === 0 ? (
                <p className="text-[11px] text-gray-400 font-body px-1">{t('labSamjho.noReports')}</p>
            ...
            <div>
              <h4 className="text-[10px] font-heading font-semibold text-gray-400 uppercase tracking-wider mb-2 px-1">{t('labSamjho.prescriptions')}</h4>
              {prescriptions.length === 0 ? (
                <p className="text-[11px] text-gray-400 font-body px-1">{t('labSamjho.noPrescriptions')}</p>
